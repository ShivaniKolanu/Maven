...
public class gift {
    ...
    { 
        ...
        while(n) {
        System.out.println("1.Eclairs");
        System.out.println("2.Melody");
        System.out.println("3.Candyman");
        System.out.println("4.candies");
        System.out.println("5.Barfi");
        ...
        case '1':
        	   ...
        	   weight=sc.nextInt();
        	   collect= new Eclairs();
        	   total_weight=collect.calculatewt( quantity, weight);
        	   totalbox_wt=totalbox_wt+total_weight;
        	   System.out.println("total weight of Eclairs : "+total_weight+"grams");
        ...
        case '2':
        	   ...
        	   System.out.println("Total weight of Melody : "+total_weight+"grams");
        	   System.out.println("Total weight of gift box : "+totalbox_wt+"grams");
        	   System.out.println("do you need another one (y/n)");
        	   n1=sc.next().charAt(0);
        	      if(n1=='y'|| n1=='Y')
        ...
        case '3':
        	...
        	System.out.println("Enter the weight in grams");
        	weight=sc.nextInt();
        	collect=new Candyman();
        	total_weight=collect.calculatewt(quantity, weight);
        	totalbox_wt=totalbox_wt+total_weight;

        	System.out.println("Total weight of Candyman : "+total_weight+"grams");
        	System.out.println("Total weight of gift box : "+totalbox_wt+"grams");
        	System.out.println("do you need another one (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
        ...
        case '5':
        	...
        	System.out.println("Total weight of Barfi : "+total_weight+"grams");
        	System.out.println("Total weight of gift box : "+totalbox_wt+"grams");
        	System.out.println("do you need another one (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
        ...
        case '6':
        	...
        	System.out.println("Total weight of Halwa : "+total_weight+"grams");
        	System.out.println("Total weight of gift box : "+totalbox_wt+"grams");
        	System.out.println("do you need another one (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
